 ...
 */
public class ForecastBoard implements Observer, WeatherBoard {
    ...
    public void display() {
        if(weatherData == null)
            ...
            System.out.println("forecast weather is "+weatherData.getTemperature()+", "+weatherData.getHumidity()+", "+weatherData.getTemperature());
    }
}
